...
<template>
	<div class="theme" :class="pageClasses">
		...
		<SideBar :open="openSideBar" :nav="true">
		...
		<SideBar :open="openSideBar" direaction="right">
			<template #sidebar-top>
				<slot name="sidebar-right-top" />
			</template>
			<template #sidebar-body>
				<slot name="sidebar-right-body" />
			</template>
			<template #sidebar-bottom>
				<slot name="sidebar-right-bottom" />
			</template>
		</SideBar>
